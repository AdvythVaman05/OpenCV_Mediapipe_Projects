...
#         filter_runtime = multi_filter_runtime[0]  # Use the first (and only) filter
...
#         cv2.putText(frame, "Press ESC to exit", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, .5, (255, 0, 0), 1)
